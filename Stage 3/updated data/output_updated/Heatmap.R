...
phenicol= AMR_ordered[, c("catA1", "catA2", "cmlA5", "floR")]

#extract the genes that are in sulfonamide class
sulphonamide = AMR_ordered[, c("sul1", "sul2")]

#extract the genes that are in trimethoprim class
trimethoprim = AMR_ordered[, c("dfrA19", "dfrA23")]

#extract the genes that are in betalactam class
betalactam = AMR_ordered[, c("blaOXA-10", "blaSCO-1", "blaTEM-1", "blaCTX-M-15","blaSHV-12")]

#extract the genes that are in macrolide class
macrolide = AMR_ordered[, c("ere(A)","mph(A)")]

#extract the genes that are in quinolone class
quinolone = AMR_ordered[,c("qnrA1","qnrB2")]
...
plasmidtyp_ordered_selected=plasmidtyp_ordered[, c("Col(BS512)_1","IncA/C2_1","IncHI2A_1","IncHI2_1","IncI1_1_Alpha","IncQ1_1","IncY_1")]
...
#draw the heatmap 
ht1 = Heatmap(phenicol, row_order = tip_lable, name = "phenicol",col=col_fun, column_title = "phenicol", column_title_rot = 90, border_gp = gpar(col = "black")) 
ht2 = Heatmap(sulphonamide,row_order = tip_lable, name="sulphonamide", col=col_fun, column_title = "sulphonamide", column_title_rot = 90,border_gp = gpar(col = "black"))
ht3 = Heatmap(trimethoprim, row_order = tip_lable, name = "trimethoprim", col = col_fun, column_title = "trimethoprim", column_title_rot = 90,border_gp = gpar(col = "black"))
ht4 = Heatmap(betalactam, row_order = tip_lable, name = "betalactam", col = col_fun, column_title = "betalactam", column_title_rot = 90,border_gp = gpar(col = "black"))
ht5 = Heatmap(macrolide, row_order = tip_lable, name = "macrolide", col = col_fun, column_title = "macrolide", column_title_rot = 90,border_gp = gpar(col = "black"))
ht6 = Heatmap(quinolone, row_order = tip_lable, name = "quinolone", col = col_fun, column_title = "quinolone", column_title_rot = 90,border_gp = gpar(col = "black"))
ht7 = Heatmap(plasmidtyp_ordered_selected, row_order = tip_lable, name = "replicon genes", col = col_fun, column_title = "replicon genes", column_title_rot = 90,border_gp = gpar(col = "black"))
